  ...
  <el-container style="height: 100%" class="app-layout">
    <el-aside width="220px" class="sidebar">
      ...
      <el-menu router :default-active="$route.path">
        ...
        <el-menu-item v-if="can('django_ip_safeguard.view_ipaccesslog')" index="/user-access">
        ...
        <el-menu-item v-if="can('django_ip_safeguard.view_scheduledtask')" index="/scheduled-tasks">
          <el-icon><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M864 256h-72V120a32 32 0 0 0-32-32H544a32 32 0 0 0-32 32v136H448a32 32 0 0 0-32 32v64H192a32 32 0 0 0-32 32v416a32 32 0 0 0 32 32h672a32 32 0 0 0 32-32V480a32 32 0 0 0-32-32zM576 120h96v136h-96V120zM288 768V480h224v288H288zm288-384v136H544V384H576zm224 192v288H544V576h224z"/></svg></el-icon>
          {{ t('nav.scheduledTasks') }}
        </el-menu-item>
        <el-menu-item v-if="can('django_ip_safeguard.view_ipguardpolicy')" index="/security-audit">
